...
public class UserDAO {
	...
	public List findByQqnumber(Object qqnumber) {
		return findByProperty(QQNUMBER, qqnumber);
	}

	public List findByUpicture(Object upicture) {
		return findByProperty(UPICTURE, upicture);
	}
